...
function closeDialogBox() {
    ...
    return (
        <div className="container mt-4 text-center">
            ...
            {showModal && (
                <Modal onClose={closeDialogBox} onDelete={() => handleDelete(selectedCourse)} />
            )}
            <div>
                    ...
                    <tbody>
                        {courses.map((course, index) => (
                            <tr key={index}>
                                ...
                                <td>
                                    <span className="me-2"><button className="btn btn-outline-secondary" type="button" onClick={dialogBox}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16">
